...
public class CommentsPrivateController {
    ...
    public CommentDto get(@PathVariable Long commentId,
        ...
        return commentsPrivateService.getCommentDtoByIdOfCommentAndUser(commentId, userId);
    }
    ...
    public List<CommentDto> get(@PathVariable Long eventId,
        ...
        return commentsPrivateService.getListCommentDto(eventId, userId, from, size);
    }
    ...
    public CommentDto update(@PathVariable Long commentId,
        ...
        return commentsPrivateService.updateCommentDto(commentId, inputCommentDto);
    }
    ...
    public void delete(@PathVariable Long commentId,
                       @PathVariable Long userId) {
        commentsPrivateService.deleteCommentDtoById(commentId, userId);
    }
}